...
function myClick() {
    ...
    var result1 = document.getElementById('scores').innerHTML = parseInt(MD5(list1), 10) % 30;
    var result2 = document.getElementById('scores').innerHTML = parseInt(MD5(list2), 10) % 30;
    var result3 = document.getElementById('scores').innerHTML = parseInt(MD5(list3), 10) % 30;
    ...
    return document.getElementById('scores').innerHTML = result.toString() + " points";
}
